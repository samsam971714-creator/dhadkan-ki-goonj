...
export class Backend implements backendInterface {
    ...
    async askCharacter(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.askCharacter(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async remixStory(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.remixStory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
